...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewPartySizeEditText.getText().equals("")||mNewPartySizeEditText.getText()==null
                || mNewGuestNameEditText.getText().equals("")||
                mNewGuestNameEditText.getText()==null){
            return;
        }
        ...
        partySize=Integer.parseInt(mNewPartySizeEditText.getText().toString());}
            ...
            Log.e(LOG_TAG, " Failed to parse party sie tect to number: "+e.getMessage());}
