...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (4) Iterate backwards through mLifecycleCallbacks, appending each String and a newline to mLifecycleDisplay
            ...
            String stringToAdd=mLifecycleCallbacks.get(i).toString();
            mLifecycleDisplay.append(stringToAdd);
            }*/
            /* Using a regresive loop because ArrayList is adding always in the front, and the first one added stay in last positions.
            * */
