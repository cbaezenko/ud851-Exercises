...
public class ReminderUtilities {
    ...
    //  - REMINDER_INTERVAL_MINUTES should be an integer constant storing the number of seconds in 15 minutes
    ...
    // every REMINDER_INTERVAL_MINUTES when the phone is charging. It will trigger WaterReminderFirebaseJobService
    ...
    public static void scheduleChargingReminder(Context context){
        ...
        myExtraBundle.putString(REMINDER_JOB_TAG, Integer.toString(REMINDER_INTERVAL_MINUTES));
