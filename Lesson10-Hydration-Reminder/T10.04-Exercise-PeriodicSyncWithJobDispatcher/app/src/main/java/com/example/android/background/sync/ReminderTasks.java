...
public class ReminderTasks {
    ...
    public static final String ACTION_SERVICE_NOTIFICATION = "service-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_SERVICE_NOTIFICATION.equals(context)){
    ...
    private static void chargingReminderNotification(Context context){
       ...
       // ReminderTasks.executeTask(context, ACTION_SERVICE_NOTIFICATION );
    }
}