...
public class MainActivity extends AppCompatActivity {
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls) {
            ...
            try {
                githubSearchUrl = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            } catch (IOException e) {
                e.printStackTrace();
            }
        ...
        @Override
        protected void onPostExecute(String githubSearchUrl){
            if(githubSearchUrl != null && !githubSearchUrl.equals(""))
