...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        changeSizePref(sharedPreferences);
    ...
    private void changeSizePref(SharedPreferences sharedPreferences){
        float value = Float.valueOf(sharedPreferences.getString(getString(R.string.pref_size_key), getString(R.string.pref_size_default)));
